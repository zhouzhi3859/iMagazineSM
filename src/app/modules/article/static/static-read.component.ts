...
@Component({
  selector: 'staticread-component',
  templateUrl: './static-read.component.html',
  styleUrls: ['./static-read.component.css', ],
}, )
export class StaticReadComponent implements OnInit, OnDestroy {
  constructor(
  ...
  public showTop() {
    this.articleService.getReadTop(this.day, ).subscribe((res, ) => {
      // 如果存在就显示
