...
@Component({
  selector: 'staticcomment-component',
  templateUrl: './static-comment.component.html',
  styleUrls: ['./static-comment.component.css', ],
}, )
export class StaticCommentComponent implements OnInit {
  constructor(
  ...
  public showTop() {
    this.articleService.getCommentTop(this.day, ).subscribe((res, ) => {
      // 如果存在就显示
